                ...
                },
                {
                    "render": function(data, type, row) {
                        if (row['status'] == "0") {
                            ...
                            var class_name = "warning";
                            var status_name = "Draft"
                        } else if (row['status'] == "2") {
                            var class_name = "danger";
                            var status_name = "Declined"
                        } else if (row['status'] == "3") {
                            var class_name = "violet";
                            var status_name = "Sent"
                        }
                        return '<span class="badge badge-pill badge-status bg-' + class_name + '" >' + status_name + '</span>';
                    }
                },
                ...
                },
                {
                    "render": function(data, type, row) {
                        if (row['status'] == "0") {
                            ...
                            var class_name = "warning";
                            var status_name = "Partially Paid"
                        } else if (row['status'] == "2") {
                            var class_name = "danger";
                            var status_name = "Unpaid"
                        } else if (row['status'] == "3") {
                            var class_name = "violet";
                            var status_name = "Overdue"
                        }
                        return '<span class="badge badge-pill badge-status bg-' + class_name + '" >' + status_name + '</span>';
                    }
                },
